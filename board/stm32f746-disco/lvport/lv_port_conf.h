...
#ifndef LV_PORT_CONF_H
#define LV_PORT_CONF_H
...
///////////////////////////////////////////////////////////////////////////////
// UNFORTUNATELY IT GENERATE HARDFAULT
...
// #define LV_VDB_ADR          ((SDRAM_ADDR)+(LV_HOR_RES*LV_VER_RES*2)) /*Place VDB to a specific address (e.g. in external RAM) (0: allocate automatically into RAM; LV_VDB_ADR_INV: to replace it later with `lv_vdb_set_adr()`)*/
///////////////////////////////////////////////////////////////////////////////
 ...
 * VDB makes the double buffering, you don't need to deal with it!
 * Typical size: ~1/10 screen */
#define LV_VDB_SIZE         ((LV_VER_RES * LV_HOR_RES)/20)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
#define LV_VDB_PX_BPP       LV_COLOR_SIZE     /*Bit-per-pixel of VDB. Useful for monochrome or non-standard color format displays. (Set `disp_drv->vdb_wr` and `disp_drv->vdb_rd` too)*/
...
#define LV_INV_FIFO_SIZE    64   /*The average count of objects on a screen */
...
#define LV_INDEV_DRAG_THROW             5                     /*Drag throw slow-down in [%]. Greater value means faster slow-down */
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "port.h"         /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (sys_get_mstick())     /*Expression evaluating to current systime in ms*/
...
#define USE_LV_FONT_DEJAVU_20              2
#define USE_LV_FONT_DEJAVU_20_LATIN_SUP    0
#define USE_LV_FONT_DEJAVU_20_CYRILLIC     0
#define USE_LV_FONT_SYMBOL_20              2
...
#define USE_LV_FONT_MONOSPACE_8            2
